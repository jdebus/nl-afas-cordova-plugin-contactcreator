		...
		if (action.equals("addContact")) {
            ...
            try {
                ...
                if (contact != null) {				
                    ...
                    if (contact.getString("displayName") != "" && contact.getString("displayName") != "null") { 
						intent.putExtra(ContactsContract.Intents.Insert.NAME, contact.getString("displayName")); 
					}
                    
					if (contact.getString("phoneHome") != "" && contact.getString("phoneHome") != "null") { 
					...
					if (contact.getString("phoneWork") != "" && contact.getString("phoneWork") != "null") { 
						if (phone_count == 0) {
					...
					if (contact.getString("mobileHome") != "" && contact.getString("mobileHome") != "null") { 
						if (phone_count == 0) {
					...
					if (contact.getString("emailHome") != "" && contact.getString("emailHome") != "null") { 
					...
					if (contact.getString("emailWork") != "" && contact.getString("emailWork") != "null") {
						if (email_count == 0) {
